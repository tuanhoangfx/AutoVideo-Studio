...
export function HeaderOutputSettings() {
        ...
        >
          ...
          >
            ...
            <div className="space-y-2 p-4 text-[12px]">
              ...
              <SettingsMenuRow icon={<Film size={14} />} title="Video Export Length" description="Image: total image time. Script: read time — trim or stop vs images.">
                <Segmented options={['image', 'script'] as const} value={settings.exportDurationMode} onChange={(v) => update({ ...settings, exportDurationMode: v })} transform={(v) => (v === 'image' ? 'Image' : 'Script')} />
              </SettingsMenuRow>
